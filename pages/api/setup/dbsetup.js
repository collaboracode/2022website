...
export default async function handler(req, res) {
 ...
 const nextAuthDBCmd = new CreateTableCommand({
 ...
 let nadbResult = await client.send(nextAuthDBCmd);

  return res.status(201).json({ message: "Tables created", userResult, blogResult, nadbResult });
}